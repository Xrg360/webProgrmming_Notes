...
- `asort()`: Sort by **values** in **ascending order** and maintain key associations.
- `arsort()`: Sort by **values** in **descending order** and maintain key associations
...
- `explode(" ",$array)`: the explode function explodes a string into sub strings and return them as array.
